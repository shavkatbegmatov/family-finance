...
public enum PermissionCode {
    ...
    POINTS_ASSIGN_TASK("POINTS", "ASSIGN"),
    POINTS_VERIFY_TASK("POINTS", "VERIFY"),
    POINTS_AWARD("POINTS", "AWARD"),
    POINTS_CONVERT("POINTS", "CONVERT"),
    POINTS_VIEW_LEADERBOARD("POINTS", "LEADERBOARD"),
    POINTS_MANAGE_ACHIEVEMENTS("POINTS", "ACHIEVEMENTS"),
    POINTS_MANAGE_EVENTS("POINTS", "EVENTS"),
    POINTS_MANAGE_SHOP("POINTS", "SHOP"),
    POINTS_MANAGE_CHALLENGES("POINTS", "CHALLENGES");
