...
VALUES ('admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZRGdjGj/n3.rSKmBnYLvNKJbLK/Wa', 'Administrator', 'admin@familyfinance.uz', '+998901234567', 'ADMIN', true);

-- Sample seller user (password: seller123)
INSERT INTO users (username, password, full_name, email, phone, role, active)
VALUES ('seller', '$2a$10$rDkPvvAFV8kqwvKJzwlHMOuHxfxXe7hZ/ZBUZfFMEfUYNVByWaJHi', 'Sotuvchi', 'seller@familyfinance.uz', '+998901234568', 'SELLER', true);
...
('Oziq-ovqat', 'Oziq-ovqat xarajatlari', NULL, true),
('Transport', 'Transport xarajatlari', NULL, true),
('Kommunal xizmatlar', 'Kommunal to''lov xarajatlari', NULL, true),
('Boshqa xarajatlar', 'Boshqa turdagi xarajatlar', NULL, true);
